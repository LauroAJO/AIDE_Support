...
// simples (sem badge). Área/País mantidos como badges pequenos (não há um
// botão "remover" equivalente ao de Notícias nesta lista — a coluna Ações
// aqui já continha só os 3 ícones funcionais da vaga: Ver, Vincular,
// Adicionar; não há um item a reduzir para "só a lixeira").
...
function VagasListTable({ items, sortKey, sortDir, onSort, onOpen, onAdd, added, onLinkTask }) {
  if (items.length === 0) {
    return (
      <div className="rounded-xl border border-line bg-surface px-4 py-12 text-center text-sm text-muted">
        Nenhuma vaga corresponde aos filtros.
